#!/usr/bin/env python3
"""Generates LSM/Localizable.xcstrings from a curated translation table.
...
add("Round %lld / %lld", "Ronda %lld / %lld", "Runde %lld / %lld", "Manche %lld / %lld", "Ronde %lld / %lld", "Turno %lld / %lld")
...
add("Week cap reached", "Límite de semanas alcanzado", "Wochenlimit erreicht", "Limite de semaines atteinte", "Wekenlimiet bereikt", "Limite di settimane raggiunto")
add("Runs for up to %lld matchdays, then ends automatically.", "Dura hasta %lld jornadas y luego termina automáticamente.", "Läuft über bis zu %lld Spieltage und endet dann automatisch.", "Dure jusqu'à %lld journées, puis se termine automatiquement.", "Loopt tot %lld speeldagen en stopt dan automatisch.", "Dura fino a %lld giornate, poi termina automaticamente.")
add("No ads · 1 league · 9 games", "Sin anuncios · 1 liga · 9 partidas", "Werbefrei · 1 Liga · 9 Spiele", "Sans pub · 1 ligue · 9 parties", "Geen advertenties · 1 competitie · 9 spellen", "Senza pubblicità · 1 lega · 9 partite")
add("Ad-supported · 1 league · 2 games", "Con anuncios · 1 liga · 2 partidas", "Mit Werbung · 1 Liga · 2 Spiele", "Avec pub · 1 ligue · 2 parties", "Met advertenties · 1 competitie · 2 spellen", "Con pubblicità · 1 lega · 2 partite")
add("No ads · 3 leagues · 9 games · PWA player links (60)", "Sin anuncios · 3 ligas · 9 partidas · enlaces de jugador PWA (60)", "Werbefrei · 3 Ligen · 9 Spiele · PWA-Spieler-Links (60)", "Sans pub · 3 ligues · 9 parties · liens joueur PWA (60)", "Geen advertenties · 3 competities · 9 spellen · PWA-spelerlinks (60)", "Senza pubblicità · 3 leghe · 9 partite · link giocatore PWA (60)")
add("No ads · 5 leagues · 15 games · PWA player links (100)", "Sin anuncios · 5 ligas · 15 partidas · enlaces de jugador PWA (100)", "Werbefrei · 5 Ligen · 15 Spiele · PWA-Spieler-Links (100)", "Sans pub · 5 ligues · 15 parties · liens joueur PWA (100)", "Geen advertenties · 5 competities · 15 spellen · PWA-spelerlinks (100)", "Senza pubblicità · 5 leghe · 15 partite · link giocatore PWA (100)")
add("No ads · 7 leagues · 21 games · PWA player links (140)", "Sin anuncios · 7 ligas · 21 partidas · enlaces de jugador PWA (140)", "Werbefrei · 7 Ligen · 21 Spiele · PWA-Spieler-Links (140)", "Sans pub · 7 ligues · 21 parties · liens joueur PWA (140)", "Geen advertenties · 7 competities · 21 spellen · PWA-spelerlinks (140)", "Senza pubblicità · 7 leghe · 21 partite · link giocatore PWA (140)")
add("This Predictor game has reached its %lld-week cap and can't open another matchday.", "Este juego de Predictor ha alcanzado su límite de %lld semanas y no puede abrir otra jornada.", "Dieses Predictor-Spiel hat sein Limit von %lld Wochen erreicht und kann keinen weiteren Spieltag mehr öffnen.", "Cette partie Predictor a atteint sa limite de %lld semaines et ne peut plus ouvrir de journée.", "Deze Predictor-wedstrijd heeft de limiet van %lld weken bereikt en kan geen nieuwe speeldag meer openen.", "Questa partita Predictor ha raggiunto il limite di %lld settimane e non può aprire un'altra giornata.")
...
print("Wrote LSM/Localizable.xcstrings with", len(T), "translated keys.")
