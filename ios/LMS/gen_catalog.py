...
add("Declare", "Declarar", "Erklären", "Déclarer", "Bevestigen", "Dichiara")
...
add("Rollover Round", "Ronda de prórroga", "Verlängerungsrunde", "Manche prolongée", "Doorrolronde", "Turno di riporto")
...
add("The 1 tied player carries forward and replays.", "El jugador empatado continúa y vuelve a jugar.", "Der 1 punktgleiche Spieler kommt weiter und spielt erneut.", "Le joueur à égalité poursuit et rejoue.", "De gelijke speler gaat door en speelt opnieuw.", "Il giocatore a pari merito prosegue e rigioca.")
...
add("1 player reinstated, picks reset.", "1 jugador readmitido, selecciones reiniciadas.", "1 Spieler wieder dabei, Tipps zurückgesetzt.", "1 joueur réintégré, choix réinitialisés.", "1 speler teruggeplaatst, keuzes gereset.", "1 giocatore reintegrato, scelte azzerate.")
