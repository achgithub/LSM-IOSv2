...
-- new `manager_token` column on `attest_devices` has to be added here instead).
--
...
--   wrangler d1 execute lsm-api-uk-db --remote --env uk --file=./migrations/0004_add_attest_devices_manager_token.sql
--   wrangler d1 execute lsm-api-eu-db --remote --env eu --file=./migrations/0004_add_attest_devices_manager_token.sql

ALTER TABLE attest_devices ADD COLUMN manager_token TEXT;
