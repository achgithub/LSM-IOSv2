/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env=uk` (hash: 1c859f62aa2d9cc64130e633da362e64)
// Runtime types generated with workerd@1.20260625.1 2026-06-14 nodejs_compat
interface __BaseEnv_Env {
	...
	// Secrets — region-prefixed, set via `wrangler secret put <KEY> --env <region>`
	UK_ATTEST_CHALLENGE_KEY: string;
	UK_JWT_PRIVATE_KEY: string;
	UK_ADMIN_TOKEN: string;
	EU_ATTEST_CHALLENGE_KEY: string;
	EU_JWT_PRIVATE_KEY: string;
	EU_ADMIN_TOKEN: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "REGION" | "APP_ATTEST_TEAM_ID" | "APP_ATTEST_BUNDLE_ID" | "APP_ATTEST_ENV" | "JWT_KID" | "JWT_PUBLIC_KEYS">> {}
}
