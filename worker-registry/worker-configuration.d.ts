/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c5b1935f6a4b768424a23bb36510885d)
// Runtime types generated with workerd@1.20260617.1 2026-06-14 nodejs_compat
interface __BaseEnv_Env {
	MANIFEST: KVNamespace;
	// SECRET, same value as every league env's OPS_SYNC_TOKEN — see auth.ts requireOps.
	OPS_SYNC_TOKEN: string;
}
